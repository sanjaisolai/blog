...
async def query_rag_stream(user_query: str, conversation_history: str = ""):
    """Streaming version of RAG query function"""
    try:
        ...
        print(f"Error in query_rag_stream: {e}")
        # For errors, we'll need to yield an error message
        class MockStream:
